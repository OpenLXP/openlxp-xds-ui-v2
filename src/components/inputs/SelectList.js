    ...
    <Menu as='div' className='relative inline-block text-left mt-0.5'>
      <div className='flex flex-col gap-2'>
        <Menu.Button
          ...
          className="relative px-5 py-2.5 gap-2 inline-flex transition-all ease-in duration-75 dark:bg-gray-900 rounded-md hover:bg-opacity-0 border-2 border-dark-blue text-dark-blue hover:shadow-lg hover:bg-blue-custom hover:font-bold"
        >
