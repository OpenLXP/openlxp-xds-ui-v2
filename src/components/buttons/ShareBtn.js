...
export default function ShareButton({ id, courseTitle, courseDescription }) {
  ...
  return (
    ...
    <button
      onClick={handleClick}
      className='flex items-center gap-2 min-w-max whitespace-nowrap p-2 text-center text-purple-custom  hover:shadow-md rounded-sm bg-purple-50 hover:bg-purple-custom hover:text-white font-medium transform transition-all duration-75 ease-in-out focus:ring-2 ring-blue-400 outline-none'
    >
